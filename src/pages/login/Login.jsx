    ...
    <div className="container">
        <div className="main_div flex flex-col justify-center items-center min-h-screen ">
          <a className='py-5 mt-32 px-9 font-nunito bg-brand rounded-[20px] font-semibold text-3xl text-secondary'  href="#">ChatApp</a>
              <h6 className='text-4xl font-nunito font-bold text-primary pt-5 pb-2.75'>Login</h6>
              ...
              <a className='py-5 px-52 bg-brand rounded-[86px] mt-12.5 font-nunito text-secondary font-semibold text-[20px]' href="/">Sign In</a>
        </div>
    </div>
